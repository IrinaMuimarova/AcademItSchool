...
public class MatrixTest {
    ...
    void testMulti() {
        ...
        Matrix matrix1 = new Matrix(new Vector[]{new Vector(new double[]{-2, 4, 3}), new Vector(new double[]{3, 1, 3})});
        Matrix matrix2 = Matrix.multiplication(matrix, matrix1);
        Assert.assertEquals(matrix2.toString(), "{{4.0, 6.0, 9.0}, {18.0, -8.0, 3.0}, {18.0, -8.0, 3.0}}");
    }
    ...
    void testMultiVector() {
        ...
        Assert.assertEquals(matrix.multiplicationOnVector(new Vector(new double[]{1, 2, -1})).toString(), "{6.0, 4.0, 0.0}");
    }
}